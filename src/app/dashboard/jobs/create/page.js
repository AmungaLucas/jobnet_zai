...
export default function CreateJobPage() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'job_title' && !formData.job_slug) {
      const slug = value
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, '-')
        .replace(/^-|-$/g, '')
      ...
      <div className="bg-white rounded-lg shadow">
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Full job description including responsibilities, requirements, and benefits..."
                  rows={6}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center h-10">
                  <label className="inline-flex items-center">
                    ...
                    />
                    <span className="ml-2 text-sm text-gray-700">Remote / Work from Home</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="SEO title for the job page"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="SEO description for the job page (150-160 characters recommended)"
                  rows={2}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
          ...
          <div className="border-t pt-6">
            ...
            <p className="text-sm text-gray-500 mb-4">These fields are automatically set when the job is created.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
